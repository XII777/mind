 ...
 *
 */
package com.peace.mind.services.timer
...
import com.peace.mind.AppConstants.FOCUS_SESSION_SERVICE_NOTIFICATION_ID
...
import com.peace.mind.helpers.device.NotificationHelper.FOCUS_CHANNEL_ID
import com.peace.mind.helpers.storage.SharedPrefsHelper
import com.peace.mind.models.FocusSession
import com.peace.mind.services.quickTiles.FocusQuickTileService
    ...
    private fun initializeSessionTimer(session: FocusSession) {
        ...
        mNotificationTimer = NotificationTimer(
            ...
            ongoingPendingIntent = AppUtils.getPendingIntentForMindfulUri(
                this,
                "com.peace.mind://open/activeSession"
            ),
            finishedPendingIntent = AppUtils.getPendingIntentForMindfulUri(
                this,
                "com.peace.mind://open/focus?tab=1"
            ),
