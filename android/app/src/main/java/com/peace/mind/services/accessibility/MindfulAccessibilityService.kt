 ...
 *
 */
package com.peace.mind.services.accessibility
...
import com.peace.mind.AppConstants.FACEBOOK_PACKAGE
import com.peace.mind.AppConstants.INSTAGRAM_PACKAGE
import com.peace.mind.AppConstants.REDDIT_PACKAGE
import com.peace.mind.AppConstants.SETTINGS_PACKAGE
import com.peace.mind.AppConstants.SNAPCHAT_PACKAGE
import com.peace.mind.AppConstants.YOUTUBE_PACKAGE
import com.peace.mind.R
import com.peace.mind.enums.PlatformFeatures
import com.peace.mind.helpers.device.PermissionsHelper
import com.peace.mind.helpers.storage.SharedPrefsHelper
import com.peace.mind.models.Wellbeing
import com.peace.mind.receivers.DeviceAppsChangedReceiver
import com.peace.mind.utils.ThreadUtils
import com.peace.mind.utils.executors.Throttler
...
class MindfulAccessibilityService : AccessibilityService(), OnSharedPreferenceChangeListener {
    companion object {
        ...
        const val ACTION_PERFORM_HOME_PRESS = "com.peace.mind.action.performHomePress"
        const val ACTION_MIDNIGHT_ACCESSIBILITY_RESET =
            "com.peace.mind.action.midnightAccessibilityReset"
        const val ACTION_TAMPER_PROTECTION_CHANGED =
            "com.peace.mind.action.tamperProtectionChanged"
