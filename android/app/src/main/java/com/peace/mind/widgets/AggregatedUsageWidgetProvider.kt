package com.peace.mind.widgets
...
import com.peace.mind.helpers.usages.NetworkUsageHelper
import com.peace.mind.helpers.usages.ScreenUsageHelper
...
class AggregatedUsageWidgetProvider : AppWidgetProvider() {
    companion object {
        ...
        private const val ACTION_REFRESH_WIDGET =
            "com.peace.mind.action.refreshAggregatedUsageWidgetProvider"
    }
    ...
    private fun setUpClickListener(context: Context, views: RemoteViews) {
        val launchPendingIntent = AppUtils.getPendingIntentForMindfulUri(
            context,
            "com.peace.mind://open/home?tab=1"
        )
