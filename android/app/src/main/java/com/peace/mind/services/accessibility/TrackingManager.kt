...
import com.peace.mind.AppConstants.SYSTEM_UI_PACKAGE
...
class TrackingManager(
    ...
    companion object {
        const val ACTION_ACCESSIBILITY_ACTIVE = "com.peace.mind.action.accessibilityActive"
        const val ACTION_ACCESSIBILITY_INACTIVE = "com.peace.mind.action.accessibilityInactive"
        const val ACTION_NEW_APP_LAUNCHED = "com.peace.mind.action.newAppLaunched"
        const val EXTRA_PACKAGE_NAME: String = "com.peace.mind.extra.packageName"
    }
