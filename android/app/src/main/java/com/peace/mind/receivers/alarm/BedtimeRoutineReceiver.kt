...
class BedtimeRoutineReceiver : BroadcastReceiver() {
    companion object {
        ...
        const val ACTION_ALERT_BEDTIME: String = "com.peace.mind.action.alertBedtime"
        const val ACTION_START_BEDTIME: String = "com.peace.mind.action.startBedtime"
        const val ACTION_STOP_BEDTIME: String = "com.peace.mind.action.stopBedtime"
        const val EXTRA_BEDTIME_SETTINGS_JSON = "com.peace.mind.extra.bedtimeSettingsJson"
    }
                ...
                NotificationCompat.Builder(
                    ...
                    .setContentIntent(
                        AppUtils.getPendingIntentForMindfulUri(
                            context,
                            "com.peace.mind://open/home?tab=3",
                        )
                    )
