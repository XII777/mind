...
object AppConstants {
    const val FLUTTER_METHOD_CHANNEL_FG: String = "com.peace.mind.methodchannel.fg"
    const val FLUTTER_METHOD_CHANNEL_BG: String = "com.peace.mind.methodchannel.bg"
    ...
    // Extra intent data
    const val INTENT_EXTRA_IS_SELF_RESTART: String = "com.peace.mind.intent.extra.isSelfRestart"
