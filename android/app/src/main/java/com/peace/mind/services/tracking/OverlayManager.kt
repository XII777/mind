package com.peace.mind.services.tracking
...
import com.peace.mind.helpers.device.NotificationHelper.USAGE_REMINDERS_CHANNEL_ID
import com.peace.mind.helpers.storage.SharedPrefsHelper
import com.peace.mind.models.RestrictionState
import com.peace.mind.services.accessibility.MindfulAccessibilityService
import com.peace.mind.services.accessibility.MindfulAccessibilityService.Companion.ACTION_PERFORM_HOME_PRESS
import com.peace.mind.services.tracking.OverlayBuilder.getAppLabelAndIcon
import com.peace.mind.utils.AppUtils
import com.peace.mind.utils.DateTimeUtils
            ...
            NotificationCompat.Builder(
                ...
                .setContentIntent(
                    AppUtils.getPendingIntentForMindfulUri(
                        context,
                        "com.peace.mind://open/appDashboard?package=$packageName"
                    )
                )
                .build()
        )
