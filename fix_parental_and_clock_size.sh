#!/usr/bin/env bash
set -e
echo "Fixing parental controls blank screen + enlarging flip clock..."
mkdir -p "lib/ui/screens/parental_controls"
cat > "lib/ui/screens/parental_controls/parental_controls_screen.dart" << 'FIX2_EOF'
/*
 *
        ...
        NavbarItem(
          ...
          sliverBody: CustomScrollView(
            ...
            slivers: [
              ...
              const TamperLockDurationSection().sliver,
...
cat > "lib/ui/screens/active_session/active_session_screen.dart" << 'FIX2_EOF'
/*
 *
 *  * Copyright (c) 2024 Mindful (https://github.com/akaMrNagar/Mindful)
 *  * Author : Pawan Nagar (https://github.com/akaMrNagar)
          ...
          NavbarItem(
            ...
            sliverBody: CustomScrollView(
              ...
              slivers: [
                ...
                /// Countdown timer - sized to prominently fill the
                /// available width, similar to a real desk flip clock
                LayoutBuilder(
                  builder: (context, constraints) {
                    final screenWidth = MediaQuery.sizeOf(context).width;
                    final fontSize =
                        (screenWidth / 6.2).clamp(44.0, 96.0).toDouble();
